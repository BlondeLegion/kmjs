//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.useVariable.integration.spec.ts
...
import { generateUseVariablePermutations } from "../../integration/fixtures/useVariable.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generateUseVariablePermutations();

createIntegrationTestSuite(
  "Integration: UseVariable Virtual Action",
  permutations,
  ({ name, action }) => {
