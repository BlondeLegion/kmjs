// tests/test_virtual_actions/integration/kmjs.virtualAction.copy.integration.spec.ts
import {
...
import { generateCopyPermutations } from "../../integration/fixtures/copy.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generateCopyPermutations();

createIntegrationTestSuite(
  "Integration: Copy Virtual Action",
  permutations,
  ({ name, action }) => {
