//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.open.integration.spec.ts
...
import { generateOpenPermutations } from "../../integration/fixtures/open.permutations";
...
const permutations = generateOpenPermutations() as Array<{
  name: string;
...
createIntegrationTestSuite(
  "Integration: Open Virtual Action",
  permutations,
  ({ name, action }) => {
