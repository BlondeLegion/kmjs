...
import { generatePlaySoundPermutations } from "../../integration/fixtures/playSound.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generatePlaySoundPermutations();

createIntegrationTestSuite(
  "Integration: PlaySound Virtual Action",
  permutations,
  ({ name, action }) => {
