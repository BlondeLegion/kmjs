//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.openURL.integration.spec.ts
...
import { generateOpenURLPermutations } from "../../integration/fixtures/openURL.permutations";
...
const permutations = generateOpenURLPermutations() as Array<{
  name: string;
...
createIntegrationTestSuite(
  "Integration: OpenURL Virtual Action",
  permutations,
  ({ name, action }) => {
