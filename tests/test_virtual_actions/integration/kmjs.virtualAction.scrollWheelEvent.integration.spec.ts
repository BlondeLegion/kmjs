//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.scrollWheelEvent.integration.spec.ts
...
import { generateScrollWheelEventPermutations } from "../../integration/fixtures/scrollWheelEvent.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generateScrollWheelEventPermutations() as Array<{
  name: string;
  action: import("../../../src/virtual_actions/index").VirtualAction;
}>;

createIntegrationTestSuite(
  "Integration: ScrollWheelEvent Virtual Action",
  permutations,
  ({ name, action }) => {
