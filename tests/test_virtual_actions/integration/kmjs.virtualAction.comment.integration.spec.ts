// FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.comment.integration.spec.ts
...
import { generateCommentPermutations } from "../../integration/fixtures/comment.permutations";
...
const permutations = generateCommentPermutations() as Array<{
  name: string;
...
createIntegrationTestSuite(
  "Integration: Comment Virtual Action",
  permutations,
