//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.paste.integration.spec.ts
...
import { generatePastePermutations } from "../../integration/fixtures/paste.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generatePastePermutations();

createIntegrationTestSuite(
  "Integration: Paste Virtual Action",
  permutations,
  ({ name, action }) => {
