//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.return.integration.spec.ts
...
import { generateReturnPermutations } from "../../integration/fixtures/return.permutations";
...
const permutations = generateReturnPermutations() as Array<{
  name: string;
...
createIntegrationTestSuite(
  "Integration: Return Virtual Action",
  permutations,
