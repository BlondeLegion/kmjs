...
import { generatePausePermutations } from "../../integration/fixtures/pause.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

const permutations = generatePausePermutations();

createIntegrationTestSuite(
  "Integration: Pause Virtual Action",
  permutations,
  ({ name, action }) => {
