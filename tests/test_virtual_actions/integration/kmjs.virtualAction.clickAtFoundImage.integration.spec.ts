//FILE: tests/test_virtual_actions/integration/kmjs.virtualAction.clickAtFoundImage.integration.spec.ts
...
import { generateClickAtFoundImagePermutations } from "../../integration/fixtures/clickAtFoundImage.permutations";
import { createIntegrationTestSuite } from "../../integration/utils/integration-test-framework";

// Generate permutations
const permutations = generateClickAtFoundImagePermutations();

// Create the integration test suite
createIntegrationTestSuite(
  "Integration: ClickAtFoundImage Virtual Action",
  permutations,
  ({ name, action }) => {
